...
public class Music {
    ...
    public static List<Music> getList(){
        ...
        music1.setArtist("Shayea");
        music1.setName("Khiz");
        music1.setCoverResId(R.drawable.music_1_cover);
        music1.setArtistResId(R.drawable.shayea);
        music1.setMusicFileResId(R.raw.music_1);

        Music music2 = new Music();
        music2.setArtist("Shayea");
        music2.setName("Makhlase Kaloom");
        music2.setCoverResId(R.drawable.music_2_cover);
        music2.setArtistResId(R.drawable.shayea);
        music2.setMusicFileResId(R.raw.music_2);

        Music music3 = new Music();
        music3.setArtist("Shayea");
        music3.setName("Refigh Fabrik");
        music3.setCoverResId(R.drawable.music_3_cover);
        music3.setArtistResId(R.drawable.shayea);
